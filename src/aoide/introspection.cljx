...
(defonce _add-introspection-to-the-world (swap! my.w/s-world assoc :introspection []))

(def intro-agent (agent {}))

#+cljs
(q/defcomponent Introspection [data]
  (html
    [:.ui.segment
