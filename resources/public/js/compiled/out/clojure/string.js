...
{{
var G__14811 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14811;
continue;
}
} else
...
{var pred__14815 = cljs.core._EQ_;var expr__14816 = limit;if(cljs.core.truth_(pred__14815.call(null,1,expr__14816)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14815.call(null,2,expr__14816)))
...
var G__14818 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14819 = (limit__$1 - 1);
var G__14820 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14818;
limit__$1 = G__14819;
parts = G__14820;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___14822 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___14822))
{var replacement_14823 = temp__4124__auto___14822;buffer.append([cljs.core.str(replacement_14823)].join(''));
} else
{buffer.append(ch);
}
{
var G__14824 = (index + 1);
index = G__14824;
continue;
}
}
