...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17968 = 0;while(true){
var m_17969 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17969 == null))
{} else
{m_17969.call(null);
if((count_17968 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17970 = (count_17968 + 1);
count_17968 = G__17970;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7871__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7871__auto__)
