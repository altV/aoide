...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_23983 = (0);while(true){
var m_23984 = cljs.core.async.impl.dispatch.tasks.pop();if((m_23984 == null))
{} else
{m_23984.call(null);
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__9065__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__9065__auto__)
