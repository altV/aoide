...
sablono.util.ToString = (function (){var obj14830 = {};return obj14830;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__7871__auto__ = x;if(and__7871__auto__)
...
{var x__8510__auto__ = (((x == null))?null:x);return (function (){var or__7883__auto__ = (sablono.util.to_str[goog.typeOf(x__8510__auto__)]);if(or__7883__auto__)
{return or__7883__auto__;
} else
{var or__7883__auto____$1 = (sablono.util.to_str["_"]);if(or__7883__auto____$1)
...
sablono.util.ToURI = (function (){var obj14832 = {};return obj14832;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__7871__auto__ = x;if(and__7871__auto__)
...
{var x__8510__auto__ = (((x == null))?null:x);return (function (){var or__7883__auto__ = (sablono.util.to_uri[goog.typeOf(x__8510__auto__)]);if(or__7883__auto__)
{return or__7883__auto__;
} else
{var or__7883__auto____$1 = (sablono.util.to_uri["_"]);if(or__7883__auto____$1)
{return or__7883__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__14833){
var xs = cljs.core.seq(arglist__14833);
...
*/
sablono.util.camel_case_keys = (function camel_case_keys(m){var f = (function (p__14838){var vec__14839 = p__14838;var k = cljs.core.nth.call(null,vec__14839,0,null);var v = cljs.core.nth.call(null,vec__14839,1,null);if((k instanceof cljs.core.Keyword))
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__14840_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__14840_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__14840_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__14840_SHARP_))
{return p1__14840_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__14841){
var maps = cljs.core.seq(arglist__14841);
...
*/
sablono.util.normalize_element = (function normalize_element(p__14846){var vec__14849 = p__14846;var tag = cljs.core.nth.call(null,vec__14849,0,null);var content = cljs.core.nthnext.call(null,vec__14849,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__14850 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__14850,0,null);var id = cljs.core.nth.call(null,vec__14850,1,null);var class$ = cljs.core.nth.call(null,vec__14850,2,null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__7883__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__7883__auto__))
{return or__7883__auto__;
} else
